        ...
        document.querySelectorAll(".item-story").forEach((item,index) => {
            if (item.contains(e.target)) {
                ...
                storySwiper.on("slideChange", (swiper) => {
                    ...
                    if(activeSlide) {
                        activeSlide.querySelectorAll(".story-modal__progress-bar span")[activeIdx].style.transitionDuration = '0s'
                ...
                function setContent() {
                    ...
                    if(initSl.tagName.toLowerCase() == "video") {
                        activeSlide.querySelector(".media-cover video").addEventListener("loadedmetadata", (event) => {
                            ...
                            activeSlide.querySelectorAll(".story-modal__progress-bar span")[activeIdx].style.transitionDuration = videoDur + 's'
                            ...
                            timeOut = setTimeout(autoPlay, videoDur * 1000);
                        }) 
                    } else {
                        activeSlide.querySelectorAll(".story-modal__progress-bar span")[activeIdx].style.transitionDuration = '15s'
                        activeSlide.querySelectorAll(".story-modal__progress-bar")[activeIdx].classList.add("seen")
                        timeOut = setTimeout(autoPlay, 15 * 1000);
                    }
                        ...
                        if(activeSlide) {
                            activeSlide.querySelectorAll(".story-modal__progress-bar").forEach((item,idx) => {
                                if (idx >= activeIdx - 1) {
                                    ...
                                    item.classList.remove("seen")  
                                    setTimeout(() => {
                                         item.querySelector("span").style.transition = null
                                     }, 0);          
                                }
                            })
                        } 
                ...
                function next() {
                    if (!thisAnimation) {
                        ...
                        if(activeSlide) {
                            ...
                            setTimeout(() => {
                               activeSlide.querySelectorAll(".story-modal__progress-bar span")[activeIdx].style.transition = null 
                            }, 0);                     
                        }
                        autoPlay()
                    }
